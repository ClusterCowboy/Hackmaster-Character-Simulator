...
namespace Testing.CharacterTests
{
    ...
    public class CharacterTests
    {
        ...
        public void CharacterBurdenTest()
        {
            ...
            Assert.AreEqual(pc.GetCurrentWeightStatus(), PlayerCharacterEnums.WeightStatus.Unencumbered);

            WeaponAccessor weaponCatalog = new WeaponAccessor();
            pc.EquipWeapon(weaponCatalog.MeleeWeaponsCatalog["Battle axe"]);

            Assert.AreEqual(pc.GetCurrentWeightStatus(), PlayerCharacterEnums.WeightStatus.Light);

            pc.EquipWeapon(weaponCatalog.MeleeWeaponsCatalog["Footman's mace"]);

            Assert.AreEqual(pc.GetCurrentWeightStatus(), PlayerCharacterEnums.WeightStatus.Moderate);

            pc.EquipWeapon(weaponCatalog.MeleeWeaponsCatalog["Footman's mace"]);

            Assert.AreEqual(pc.GetCurrentWeightStatus(), PlayerCharacterEnums.WeightStatus.HeavyLaden);

            pc.EquipWeapon(weaponCatalog.MeleeWeaponsCatalog["Footman's mace"]);
            pc.EquipWeapon(weaponCatalog.MeleeWeaponsCatalog["Footman's mace"]);
            pc.EquipWeapon(weaponCatalog.MeleeWeaponsCatalog["Footman's mace"]);

            Assert.AreEqual(pc.GetCurrentWeightStatus(), PlayerCharacterEnums.WeightStatus.Severe);
            ...
            Assert.AreEqual(pc.GetCurrentWeightStatus(), PlayerCharacterEnums.WeightStatus.Overloaded);
